...
function FlyingMenuInit() {
	wp_enqueue_style('flying-menu', plugins_url('flying-menu') . '/styles/flying-menu.css', array(), '1.0', 'all');
	wp_enqueue_script('jquery-1.9.1', plugins_url('flying-menu') . '/js/jquery-1.9.1.min.js', array( 'jquery' ), '1.9.1', true );
}

if (!is_admin()) add_action("wp_enqueue_scripts", "FlyingMenuInit", 11);
...
<?php
  ...
  function widget($args, $instance)
  {
	...
	// wp_nav_menu( array( 'menu' => 'short', 'menu_class' => 'flying-menu', 'container_id' => 'flying-menu-block' ) );
